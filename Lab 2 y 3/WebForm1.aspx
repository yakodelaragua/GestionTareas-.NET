<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm1.aspx.vb" Inherits="Lab_2_y_3.WebForm1" %>
...
<body>
    <form id="formInicio" runat="server">
        <div style="height: 322px; margin-left: 80px;" id="msgErrorDireccion">
            ...
            <br />
            <br />
            <asp:HyperLink ID="HLRegistro" runat="server" ForeColor="#0000EE" NavigateUrl="~/WebForm2.aspx">Quiero registrarme</asp:HyperLink>
            <br />
            <asp:HyperLink ID="HLCambioPass" runat="server" ForeColor="#0000EE" NavigateUrl="~/WebForm3.aspx">Modificar password</asp:HyperLink>
            <br />
            <br />
        </div>
